...
let calAndDanAppleCount = applesDict["Adam"]! + applesDict["Eve"]!
...
assert(russiaCapital == "Moscow", "expecting Moscow, but got \(String(describing: russiaCapital))")
...
var valueofCube = 0
for num in 1...20{
    valueofCube = (num * num * num)
    cubeDict[num] = valueofCube
}
